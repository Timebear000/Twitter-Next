          ...
          {selectedFile && (
            <div className="relative">
              <div
                ...
                className="abosulte w-8 h-8 bg-[#15181c] hover:bg-[#272c26] bg-opacity-75 rounded-full flex items-center justify-center top-1 left-1 cursor-pointer"
              >
...
const Picker = (props = {}) => {
  ...
  import("emoji-mart").then((EmojiMart) => {
    new EmojiMart.Picker({ ...props, data, ref, onSelect: props.onSelect });
  });
